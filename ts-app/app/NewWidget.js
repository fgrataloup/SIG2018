...
define(["require", "exports", "esri/core/tsSupport/declareExtendsHelper", "esri/core/tsSupport/decorateHelper", "esri/core/accessorSupport/decorators", "esri/widgets/Widget", "esri/widgets/support/widget"], function (require, exports, __extends, __decorate, decorators_1, Widget, widget_1) {
    ...
    var NewWidget = /** @class */ (function (_super) {
        ...
        function NewWidget() {
            ...
            //  firstValue
            //----------------------------------
            _this.firstValue = "Super";
            //----------------------------------
            //  lastValue
            //----------------------------------
            _this.lastValue = "Widget";
            //----------------------------------
            //  emphasized
            //----------------------------------
        ...
        //
        //--------------------------------------------------------------------------
        NewWidget.prototype.render = function () {
            var _a;
        ...
        //
        //--------------------------------------------------------------------------
        NewWidget.prototype._getGreeting = function () {
            return "This is a new " + this.firstValue + " " + this.lastValue + "!";
        };
        __decorate([
            decorators_1.property(),
            widget_1.renderable()
        ], NewWidget.prototype, "firstValue", void 0);
        __decorate([
            decorators_1.property(),
            widget_1.renderable()
        ], NewWidget.prototype, "lastValue", void 0);
        __decorate([
            decorators_1.property(),
            widget_1.renderable()
        ], NewWidget.prototype, "emphasized", void 0);
        NewWidget = __decorate([
            decorators_1.subclass("esri.widgets.NewWidget")
        ], NewWidget);
        return NewWidget;
    }(decorators_1.declared(Widget)));
    return NewWidget;
});
//# sourceMappingURL=NewWidget.js.map